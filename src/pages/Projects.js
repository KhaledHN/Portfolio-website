...
const Projects = () => {
  return (
    <div className=" w-full h-[1500px] flex justify-center ">
      ...
      <div className=" max-w-[1240px] h-full flex items-start px-3 pt-32 xl:pt-64 ">
        <div className=" w-full px-4 ">
          ...
          <div className=" w-full h-[1870px] xl:h-96 flex items-center justify-center xl:justify-normal overflow-x-scroll scrollbar-hide pt-10 xl:pt-0 ">
            <div className=" xl:flex col-span-8 gap-6 scale-125 xl:scale-100 ">
              <div className=" pb-12 xl:pb-0 ">
                <div className=" w-64 h-[300px] p-4 bg-zinc-900 hover:bg-zinc-800 rounded-lg ">
                  <a
                    href="https://www.hazemkhaled.com/"
